...
[The class diagram of the Book and BookItem classes](./book.png)
...
[The class diagram of the Person and Author classes](./person.png)
...
[The class diagram of the User, Librarian, and Member classes](./user.png)
...
[The class diagram of the LibraryCard class](./card.png)
...
[The class diagram of the BookReservation class](./reservation.png)
...
[The class diagram of the BookLending class](./lending.png)
...
[Enums in the library management system](./enums.png)
...
[The one-way association relationship between the classes](./onewayassociation.png)
...
[The two-way association relationship between the classes](./twowayassociation.png)
...
[The composition relationship between the classes](./composition.png)

### Aggregation
- The Catalog class contains the Book class.

[The aggregation relationship between the classes](./aggregation.png)
### Inheritance
...
[The class diagram of the library management system](./classdiagram.png)
